// Requirejs wrapper for Raven.js (https://github.com/getsentry/raven-js)
// NOTE: This is for Sonoma alpha only! Do not use this to send production exceptions.
// Contact maxj@ jdubie@ or jeandenis@ for more info
define(['external/tracekit'], function (TraceKit) {
    'use strict';
